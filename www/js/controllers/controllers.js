...
cbbApp.controller('stateController',
    function($scope, $rootScope, $location, $http, $modal,
        ...
        if (participantService.globalLoginStatus == true) {
    ...
    function ($scope, $window, $http, $location, participantService) {
        ...
        $scope.rememberMe = function() {
            window.alert('inside remember me');
        };
        ...
        $scope.submitSignupInfo = function() {
            ...
            //var newDOB1 = $scope.newParticipant.babyDOB | date:'MM/dd/yyyy'
                ...
                $http({method: 'POST',
                    ...
                    success(function(data, status, headers, config) {
                        ...
                        if($scope.appsData != undefined) {
                            ...
                            participantService.setBabyName($scope.newParticipant.babyName);
                            ...
                            $scope.babyName = participantService.getBabyName();
            ...
            $http.get('http://localhost:3000/loginSignup/' + email + '/' + $scope.password1).
                success(function (data, status, headers, config) {
                    ...
                    if ($scope.appsData != "false") {
                        ...
                        $scope.babyName = participantService.getBabyName();
                        //$window.alert($scope.babyName + ' '  + participantService.getBabyName());
